...
![2279594-dd72907e82f89fd6](resource/img/skywalking/3.png)

随着服务的越来越多，对调用链的分析会越来越复杂。它们之间的调用关系也许如下：

![img](resource/img/skywalking/2.png)
...
- Apache SkyWalking 是观察性分析平台和应用性能管理系统。提供分布式追踪、服务网格遥测分析、度量聚合和可视化一体化解决方案。

![img](resource/img/skywalking/1.png)
...
services:
  elasticsearch:
    image: wutang/elasticsearch-shanghai-zone:6.3.2 # 由于skywalking用的是6.3.2版本，但是官方镜像没有6.3.2，故使用第三方镜像
...
```json
{
  ...
  "cluster_uuid" : "OaqnYTazSlam7oP6yIfiuw",
  "version" : {
    "number" : "6.3.2",
...
![1565169033271](resource/img/skywalking/5.png)



### 启动

E:\千峰\apache-skywalking-apm-6.2.0\apache-skywalking-apm-bin\bin目录下
...
![img](resource/img/skywalking/6.png)

修改项目的 VM 运行参数，点击菜单栏中的 `Run` -> `EditConfigurations...`，此处我们以 `nacos-provider` 项目为例，修改参数如下

```bash
-javaagent:E:\spring-cloud\code\spring-cloud-alibaba\skywalking-agent\agent\skywalking-agent.jar
-Dskywalking.agent.service_name=service-provider
-Dskywalking.collector.backend_service=localhost:11800 #skywalking 的collector运行的服务器地址
```

![img](resource/img/skywalking/7.png)
...
![img](resource/img/skywalking/8.png)

访问之前写好的接口 http://localhost:8081/echo/hi 之后再刷新 SkyWalking Web UI，你会发现 Service 与 Endpoint 已经成功检测到了

![img](resource/img/skywalking/9.png)

![img](resource/img/skywalking/10.png)
...
![img](resource/img/skywalking/11.png)

点击 `Trace ID` 展开详细信息

![img](resource/img/skywalking/12.png)

![Lusifer_20190114041036](resource/img/skywalking/13.png)
...
![img](resource/img/skywalking/14.png)

选择希望监控的服务

![img](resource/img/skywalking/15.png)
...
![img](resource/img/skywalking/16.png)

![img](resource/img/skywalking/17.png)
