...
![img](resource/img/spring-cloud/7.png)
...
![img](resource/img/spring-cloud/9.png)

**刷新之前项目中的全部测试接口（刷多几次）**

点击 `Find a trace`，可以看到具体服务相互调用的数据

![img](resource/img/spring-cloud/10.png)

点击 `Dependencies`，可以发现服务的依赖关系

![img](resource/img/spring-cloud/11.png)
...
![img](resource/img/spring-cloud/8.png)